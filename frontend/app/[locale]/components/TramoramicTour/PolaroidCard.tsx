...
export default function PolaroidCard({
  ...
  return (
    ...
    >
      ...
      />
      {hashTag && (
        <p className="text-gold absolute right-0 bottom-[5vmin] left-0 truncate px-[40px] text-center font-sans text-[clamp(18px,7.3cqw,32px)]! leading-[1.25em] font-semibold tracking-[0.02em] md:bottom-[2.9vmin] lg:bottom-[40px]">
          {hashTag}
        </p>
      )}
    </div>

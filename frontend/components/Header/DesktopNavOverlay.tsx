...
export default function DesktopNavOverlay({
  ...
  return (
    <>
      ...
      />
      <div
        className={`bg-green fixed top-0 right-0 bottom-0 z-[1011] flex w-3/4 max-w-[800px] flex-col pt-[50px] text-white transition-transform duration-500 ease-in-out ${
        ...
        aria-hidden={!open}
      >
        <div className="flex shrink-0 items-center justify-between pr-15 pl-20">
        ...
        <div className="mt-[90px] flex min-h-0 flex-1 flex-col overflow-y-auto pr-15 pb-[50px] pl-20">
          <nav

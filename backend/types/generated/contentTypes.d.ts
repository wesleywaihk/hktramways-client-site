...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    mainNavExtLink: Schema.Attribute.Component<
      'global.main-nav-ext-link',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiHomeHome extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    arcCarousel: Schema.Attribute.Component<'page-home.arc-carousel', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPartyTramPartyTram extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    item: Schema.Attribute.Component<'content.party-tram-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
